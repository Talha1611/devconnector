...
<Container>
  <Row>
    ...
    <Col xs={4} md={2} style={{marginLeft:'29rem',marginBottom:'2rem'}}>
      <Image src="https://apsec.iafor.org/wp-content/uploads/sites/37/2017/02/IAFOR-Blank-Avatar-Image.jpg" roundedCircle />
    </Col>
